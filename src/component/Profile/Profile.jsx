  ...
  return (
    <div className={css.profile}>
      ...
      <li>
          ...
          <span className={css.stats__quantity}>{formatNumberWithCommas(stats.followers)}</span>
        </li>
        <li>
          <span className={css.stats__label}>Views </span>
          <span className={css.stats__quantity}>{formatNumberWithCommas(stats.views)}</span>
        </li>
        <li>
          <span className={css.stats__label}>Likes </span>
          <span className={css.stats__quantity}>{formatNumberWithCommas(stats.likes)}</span>
        </li>
      </ul>
    </div>
  );
